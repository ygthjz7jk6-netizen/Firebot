...
| **Science**    | `qwen2.5:7b`| **Researcher** – Vyhledává vědecká data a studie (PubMed). |
| **Scientist**  | `deepseek-r1:7b`| **Sci-Eng** – Návrh a virtuální testování materiálů (biomimetika, RDKit). |
